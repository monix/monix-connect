...
final case class BlobConfig(contentType: Option[String] = None,
  ...
  private[gcs] def toBlobInfo(blobId: BlobId): BlobInfo = {
...
object BlobConfig {
  private[gcs] def fromBlobId(blobId: BlobId): BlobInfo =
