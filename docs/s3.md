...
## Async Client
 ...
 There are different ways to create the connection, all of them exposed under the singleton object `monix.connect.s3.S3` and explained in more detail below:
