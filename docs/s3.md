...
The better way of using it is to make it transparent in your application and directly expect an instance of _S3_ in your methods and classes, which will be called from within the 
